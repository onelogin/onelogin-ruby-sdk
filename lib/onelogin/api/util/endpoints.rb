...
require_relative "constants" # will we stick here to the require or will we use the require_relative which 
#recommended for ruby 1.9 and hire
    ...
    module Api
      module Util
        ...
        module Endpoints
            ...
            #AUX API URL endpoints for the OneLogin's Ruby SDK.
